...
client = MongoClient('mongodb+srv://yirae:sparta@cluster0.1m6zbhy.mongodb.net/Cluster0?retryWrites=true&w=majority')
db = client.dbsparta
...
def home():
    ...
    try:
        ...
        return redirect(url_for("login2", msg="로그인 시간이 만료되었습니다."))
    except jwt.exceptions.DecodeError:
        return redirect(url_for("login2", msg="로그인 정보가 존재하지 않습니다."))
